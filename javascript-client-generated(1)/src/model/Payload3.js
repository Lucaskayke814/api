...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Sei.Payload3 = factory(root.Sei.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The Payload3 model module.
   * @module model/Payload3
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Payload3</code>.
   * @alias module:model/Payload3
   * @class
   */
  ...
  /**
   * Constructs a <code>Payload3</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Payload3} obj Optional instance to populate.
   * @return {module:model/Payload3} The populated <code>Payload3</code> instance.
   */
