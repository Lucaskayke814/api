...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Sei.Payload4 = factory(root.Sei.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The Payload4 model module.
   * @module model/Payload4
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>Payload4</code>.
   * @alias module:model/Payload4
   * @class
   */
  ...
  /**
   * Constructs a <code>Payload4</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Payload4} obj Optional instance to populate.
   * @return {module:model/Payload4} The populated <code>Payload4</code> instance.
   */
