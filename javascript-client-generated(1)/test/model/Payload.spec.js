...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Payload', function() {
      beforeEach(function() {
        instance = new Sei.Payload();
      });

      it('should create an instance of Payload', function() {
        // TODO: update the code to test Payload
        expect(instance).to.be.a(Sei.Payload);
      });
      ...
      it('should have the property idTipoProcedimento (base name: "idTipoProcedimento")', function() {
        // TODO: update the code to test the property idTipoProcedimento
        expect(instance).to.have.property('idTipoProcedimento');
        // expect(instance.idTipoProcedimento).to.be(expectedValueLiteral);
      });

      it('should have the property nivelAcesso (base name: "nivelAcesso")', function() {
        // TODO: update the code to test the property nivelAcesso
        expect(instance).to.have.property('nivelAcesso');
        // expect(instance.nivelAcesso).to.be(expectedValueLiteral);
      });
